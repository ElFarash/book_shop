...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 05, 2019 at 04:02 PM
...
INSERT INTO `books` (`id`, `title`, `rate`, `author_id`, `published_at`, `image_path`, `author_name`, `description`) VALUES
(1, 'Educated: A Memoir', 8, 2, '2019-02-10', 'https://images-na.ssl-images-amazon.com/images/I/81XR45UdqkL.jpg', 'Tara Westover', 'For readers of The Glass Castle and Wild, a stunning new memoir about family, loss and the struggle for a better future#1 International BestsellerTara'),
(2, 'Justice on Trial', 9, 1, '2019-03-11', 'https://images-na.ssl-images-amazon.com/images/I/51tQHDThsTL._SX329_BO1,204,203,200_.jpg', 'Mollie Hemingway', '#1 NATIONAL BESTSELLER! Justice Anthony Kennedy slipped out of the Supreme Court building on June 27, 2018'),
(3, 'Unfreedom of the Press ', 9, 3, '2019-05-21', 'https://images-na.ssl-images-amazon.com/images/I/81Scw9HLl5L.jpg', 'Mark Levin\r\n', 'From six-time #1 New York Times bestselling author, FOX News star, and radio host Mark R. Levin comes a groundbreaking and enlightening book that shows how the great tradition'),
...
(7, 'Maybe You Should Talk to Someone', 4, 6, '2019-04-02', 'dsfs', 'Lori Gottlieb', 'sdasd'),
